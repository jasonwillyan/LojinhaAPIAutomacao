...
public class ProdutoTest
{
    ...
    public void beaforeEach()
    {
        ...
        //Obter o token do usuario jason
        this.token = given()
    ...
    @Test
    @DisplayName("Validar que o valor do produto igual 7000.00 não é permitido")
    public void testValidarLimitesMaiorSeteMilProibidoValorProduto()
    {
        //Tentar inserir um produto com o valor 7000.00 e validar que a mensagem de erro foi apresentada
        //Status code retornado foi 422
